...
- [~] P1-5: onload 拆分（长期架构改进，跳过）
- [~] P1-6: 全局事件优化（已在第 5 轮验证，registerDomEvent 安全）
- [~] P1-7: floating-outline 性能（低优先级，未来改进）
- [~] P1-8: outliner 性能（低优先级，未来改进）
- [x] P1-9: YAML 冲突警告（已修复：添加冲突提示）
- [x] P1-10: YAML 修改提示（已修复：添加会修改文件警告）
- [x] P2-11: 设置描述风险提示（已修复：网络隐私、文档修改警告）
