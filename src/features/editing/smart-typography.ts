...
export function handleAutoPair(editor: Editor, typedChar: string, evt: KeyboardEvent): boolean {
...
export function handleSmartBackspace(editor: Editor, evt: KeyboardEvent): boolean {
